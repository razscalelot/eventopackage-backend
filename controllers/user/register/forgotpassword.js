    ...
    if (mobile && mobile != '' && mobile.length == 10) {
        ...
        if (checkExisting) {
            ...
            // if (otpSend.data.Details) {
                await primary.model(constants.MODELS.users, userModel).findByIdAndUpdate(checkExisting._id, { otpVerifyKey: '123456' });
                return responseManager.onSuccess('User mobile identified and otp sent successfully!', { key: '123456' }, res);
            // } else {

...
//                 let checkEventid = await primary.model(constants.MODELS.eventbookings, eventbookingModel).findOne({ eventId: eventId.toString() }).lean();
//                 console.log("checkEventid", checkEventid);
//                 console.log("startTimestamp", startTimestamp, endTimestamp);
//                 if ((startTimestamp >= parseFloat(checkEventid.start_timestamp) && parseFloat(checkEventid.start_timestamp) <= endTimestamp) || (startTimestamp >= parseFloat(checkEventid.end_timestamp) && parseFloat(checkEventid.end_timestamp) <= endTimestamp)) {
...
//                     }
//                 } else {
//                     return responseManager.badrequest({ message: 'Event Already booked, please try again' }, res);
//                 }
//             } else {
//                 return responseManager.badrequest({ message: 'Invalid event id to get event data, please try again' }, res);
//             }

                                ...
                                (async () => {
                                    ...
                                    async.forEachSeries(allItems, (item, next_item) => {
                                        ...
                                        items += `<tr style="text-align: left;">
                                                        ...
                                                        <td style="padding: 10px; border: 1px solid #363636; font-size: 12px; color: #363636; font-weight: 900; width: 10%;">${parseFloat(item.itemDiscountPrice).toFixed(2) ? parseFloat(item.itemDiscountPrice).toFixed(2) : parseFloat(item.price).toFixed(2)}  ${item.price_type.trim().replace('_', ' ')}</td>
